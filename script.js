...
function validateAndSpin() {
    ...
    fetchBalance(walletAddress, function (userBalance) {
        ...
        if (betAmount > userBalance) {
            ...
            // Trigger haptic feedback before the spin starts
            Telegram.WebApp.HapticFeedback.impactOccurred('heavy'); // Start continuous haptic feedback
